...
DEFAULT_BANDPASS_A = (
    ...
    -3.974428294786210180689067783533,
    5.931305335419762236881524586352,
    -3.939226621802428329743861468160,
    0.982364711720531635918973734078,
)  # IIR分母係数a. 既定値は10Hz付近を強調する低Qフィルタ.
DEFAULT_BANDPASS_B = (
