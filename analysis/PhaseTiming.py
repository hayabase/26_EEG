...
#   prototype_order: 3
#   direct_form_order: 6
#   fp: 9.8500 Hz - 10.1000 Hz
#   fs: 5.8500 Hz - 14.1000 Hz
#   gpass: 0.50 dB
#   gstop: 80.00 dB
#   gain_at_10Hz: 0.00 dB
#   near_target_max_gain: 0.00 dB at 10.0000 Hz
#   bandwidth_3db: 0.3125 Hz
#   Q: 32.00
#   target_delay: 2.21 ms
#   near_target_max_delay: 7.24 ms at 10.8950 Hz
#   time_response_gain: -2.51 dB (0.749x)
#   rise_time: 2490.00 ms to -3.00 dB
#   max_pole_abs: 0.99945238
# Rank 2: family=cheby2, Q=32.00, bandwidth_3db=0.3125 Hz, time_response_gain=-2.51 dB
...
DEFAULT_BANDPASS_B = (
    ...
    8.05576786566112455e-21,
    -2.25927475821350346e-05,
    1.80988300648415637e-05,
    -4.53499414474683036e-06,
)  
